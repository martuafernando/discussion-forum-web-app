  ...
  return (
    <div className="register-page">
      ...
      <form className="register-page__form" action="" onSubmit={onRegisterHandler}>
        ...
        <input className="register-page__name" name="name" type="text" placeholder="name" autoComplete="name"/>
        <input className="register-page__email" name="email" type="email" placeholder="email" autoComplete="email"/>
        <input className="register-page__password" name="password" type="password" placeholder="Password" autoComplete="current-password"/>
