  ...
  return (
      <main className="login-page">
        ...
        <form className="login-page__form" action="" onSubmit={onLoginHandler}>
          ...
          <input className="login-page__email" name="email" type="email" placeholder="Email" autoComplete="email" />
          <input className="login-page__password" name="password" type="password" placeholder="Password" autoComplete="current-password"/>
