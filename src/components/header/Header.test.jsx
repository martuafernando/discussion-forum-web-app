 ...
 *  - should show sign-in button when there's no user authenticated
 *  - should show avatar there's user authenticated
 *  - should query the page with the keyword when search form submited
 *  - should show the drawer-menu when state hamburgerMenu true
 *  - should hidden the drawer-menu when state hamburgerMenu false
 *  - should toggle state hamburgerMenu to be true when hamburger menu clicked
 *  - should toggle state hamburgerMenu to be false when hamburger menu clicked
 */
